...
public class Listas {
	...
	public static void main(String[] args) {
		 ...
		 * 	- inicia vazia e seus elementos são alocadas sob demanda;
		 * 	- Cada elemento ocupa um nó (node) da lista;
		 * 
		 * Tipo (interface): List
		 * 
		 ...
		 * Vantagens:
		 * 	- tamanho variável
		 * 	- facilidades para se realisar inserções e deleções
		 * 
		 * Desvantagens:
		...
		//recebe o resultado de = converte para stream.faz a operação de filtragem baseado na condição lambda.converte novamente para lista;
		...
		//atribui a variavel name = converte para stream.faz a operação de filtragem baseada na condição lambda.encontra o primeiro.se não encontrar retorna null;
