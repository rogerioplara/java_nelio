...
public class Membros_estaticos {
	...
	public static void main(String[] args) {
		 ...
		 * também Esta classe não poderá ser instânciada
		 * 
		 * exemplos: Math.sqrt(double) -> classe utilitária estática
		 * 
		 * métodos não estáticos não podem ser chamados pela função main dentro da mesma
		 * classe
		 */
