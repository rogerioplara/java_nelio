...
public class funcoes_sintaxe {
	...
	public static void main(String[] args) {
		/*
		 * Representam um processamento que possui significado - Math.sqrt(double) -
		 * System.out.println(); - pode receber um dado como argumento/parametro e pode
		 * retornar uma resposta;
		 * 
		 * Principas vantagens: modularização, delegação e reaproveitamento;
		 * 
		 * Dados de entrada e saída - funções podem receber dados de entrada (parâmetros
		 * ou argumentos) - funções podem ou não retornar uma saída
		 * 
	...
	// quando a função faz uma ação e não retorna valor para ser utilizado,
	// utiliza-se void
