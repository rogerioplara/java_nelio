...
public class funcoes_strings {
	...
	public static void main(String[] args) {
		/*
		 * funções mais utilizadas: Formatar: toLowerCase(), toUpperCase(), trim()
		 * Recortar: substring(inicio), substring(inicio, fim) Substituir: Replace(char,
		 * char), Replace(string, string) Buscar: IndexOf, LastIndexOF Comparar:
		 * equals() str.Split(" ")
		 */
